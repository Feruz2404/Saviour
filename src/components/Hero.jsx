    ...
    <div className="wrapper max-w-7xl m-auto">
      ...
      <div className="services">
        <div className="title flex flex-col justify-center items-center">
          <button className="text-customBlue text-3xl">Services we Offer</button>
      ...
      >
        ...
        <div className="w-1/2 flex justify-center align-middle m-auto">
          ...
          <div className="rec w-[16%] h-1 bg-black m-1 rounded-full ml-4"></div>
            ...
            <button className="col-span-3 border-2 border-blue-400 bg-white text-black rounded-full px-6 py-3 mt-6 mx-auto hover:bg-blue-400 hover:text-white">
              Learn more
            </button>
          </div>
        </div>
